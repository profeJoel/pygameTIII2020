...
while repetir:
	...
	heroe = personaje(int(ventana_x/2),int(ventana_y/2),"heroe",800)
	villanos = [personaje(10,ventana_y - 100,"villano",800), personaje(10,ventana_y - 100,"villano",800), personaje(10,ventana_y - 100,"villano",800), personaje(10,ventana_y - 100,"villano",800)]
	villano = villanos[nivel]
