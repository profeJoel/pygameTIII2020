...
heroe1 = personaje(int(ventana_x/2)+100,int(ventana_y/2),64,64)
heroe2 = personaje(int(ventana_x/2)-100,int(ventana_y/2),64,64)
heroe3 = personaje(int(ventana_x/2),int(ventana_y/2)+100,64,64)
heroe4 = personaje(int(ventana_x/2),int(ventana_y/2)-100,64,64)
...
def rePintarCuadroJuego():
	...
	heroe1.dibujar(ventana)
	heroe2.dibujar(ventana)
	heroe3.dibujar(ventana)
	heroe4.dibujar(ventana)
